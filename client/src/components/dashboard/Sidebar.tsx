            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link href="/">
                  ...
                  >
                    <i className="fas fa-newspaper text-gray-500 mr-2 text-sm" />
                    Landing Page
                  </a>
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link href="/profile">
                  <a
                    ...
                    className="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block"
                  >
                    <i className="fas fa-user-circle text-gray-500 mr-2 text-sm" />
                    Profile Page
                  </a>
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link href="/login">
                  <a
                    ...
                    className="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block"
                  >
                    <i className="fas fa-fingerprint text-gray-500 mr-2 text-sm" />
                    Login
                  </a>
                </Link>
              </li>
              ...
              <li className="items-center">
                ...
                >
                  <i className="fas fa-clipboard-list text-gray-400 mr-2 text-sm">
                    Register (soon)
                  </i>
                </a>
              </li>
              ...
              <li className="items-center">
                <a
                  ...
                  onClick={(e) => e.preventDefault()}
                >
                  <i className="fas fa-tools text-gray-400 mr-2 text-sm">
                    Settings (soon)
                  </i>
                </a>
              </li>
